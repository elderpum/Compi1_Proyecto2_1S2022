...
class VECTOR extends expresion_1.Expresion {
    ...
    getValor(arbol, tabla) {
        ...
        if (expre.tipo.tipos !== tipo_1.tipos.ERROR) {
            ...
            arbol.num_error++;
            arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Posición fuera del rango", this.linea, this.columna));
            return new literal_1.default(this.linea, this.columna, "ERROR", tipo_1.tipos.ERROR);
        }
        if (this.tip === "VECTOR") {
            arbol.num_error++;
            arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "El vector indicado no existe", this.linea, this.columna));
            return new literal_1.default(this.linea, this.columna, "ERROR", tipo_1.tipos.ERROR);
        }
        else {
            arbol.num_error++;
            arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "La lista indicada no existe", this.linea, this.columna));
            return new literal_1.default(this.linea, this.columna, "ERROR", tipo_1.tipos.ERROR);
        }
    }
    getNodo() {
