        ...
        if (condicion.Tipo.tipos !== tipo_1.tipos.ERROR) {
            if (condicion.Tipo.tipos === tipo_1.tipos.BOOLEANO) {
                if (condicion.valor) {
                    ...
                    arbol.num_error++;
                    arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "el valor indicado no existe", this.linea, this.columna));
            ...
            arbol.num_error++;
            arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "se esperaba un valor Bolean", this.linea, this.columna));
            return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
        }
        arbol.num_error++;
