    ...
    getValor(arbol, tabla) {
        ...
        switch (this.tipo.tipos) {
            case tipo_1.tipos.CADENA:
                arbol.num_error++;
                arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "No se puede hacer casteo de un string", this.linea, this.columna));
                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
            case tipo_1.tipos.BOOLEANO:
                arbol.num_error++;
                arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "No se puede hacer casteo de double", this.linea, this.columna));
                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
            case tipo_1.tipos.DOBLE:
                switch (valor === null || valor === void 0 ? void 0 : valor.Tipo.tipos) {
                    case tipo_1.tipos.BOOLEANO:
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "No se puede hacer casteo de double a boolean", this.linea, this.columna));
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                    case tipo_1.tipos.CARACTER:
                        return new literal_1.default(this.linea, this.columna, valor.valor.charCodeAt(), tipo_1.tipos.DOBLE);
                    case tipo_1.tipos.CADENA:
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "No se puede hacer casteo de double a string", this.linea, this.columna));
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
            ...
            case tipo_1.tipos.ENTERO:
                switch (valor === null || valor === void 0 ? void 0 : valor.Tipo.tipos) {
                    case tipo_1.tipos.BOOLEANO:
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "No se puede hacer casteo de int a boolean", this.linea, this.columna));
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                    case tipo_1.tipos.CARACTER:
                        return new literal_1.default(this.linea, this.columna, valor.valor.charCodeAt(), tipo_1.tipos.ENTERO);
                    case tipo_1.tipos.CADENA:
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "No se puede hacer casteo de int a string", this.linea, this.columna));
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                    case tipo_1.tipos.ENTERO:
            ...
            case tipo_1.tipos.CARACTER:
                switch (valor === null || valor === void 0 ? void 0 : valor.Tipo.tipos) {
                    case tipo_1.tipos.BOOLEANO:
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "No se puede hacer casteo de caracter a boolean", this.linea, this.columna));
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                    case tipo_1.tipos.CARACTER:
                        return new literal_1.default(this.linea, this.columna, valor.valor, tipo_1.tipos.ENTERO);
                    case tipo_1.tipos.CADENA:
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "No se puede hacer casteo de caracter a cadena", this.linea, this.columna));
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                    case tipo_1.tipos.ENTERO:
                    ...
                    case tipo_1.tipos.DOBLE:
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "No se puede hacer casteo de caracter a double", this.linea, this.columna));
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                }
        }
        arbol.num_error++;
        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "La variable indicada no esta declarada", this.linea, this.columna));
        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
    }
    getNodo() {
        var _a;
