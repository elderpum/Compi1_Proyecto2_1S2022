    ...
    getValor(arbol, tabla) {
        ...
        switch (this.operador) {
                ...
                switch (izquierda === null || izquierda === void 0 ? void 0 : izquierda.Tipo.tipos) {
                    case tipo_1.tipos.ENTERO:
                        switch (derecha === null || derecha === void 0 ? void 0 : derecha.Tipo.tipos) {
                            case tipo_1.tipos.BOOLEANO:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un Entero con un booleano", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.CADENA:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un Entero con un string", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                    ...
                    case tipo_1.tipos.CARACTER:
                        switch (derecha === null || derecha === void 0 ? void 0 : derecha.Tipo.tipos) {
                            case tipo_1.tipos.BOOLEANO:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un char con un booleano", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.CADENA:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un char con un string", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.CARACTER:
                    ...
                    case tipo_1.tipos.CADENA:
                        switch (derecha === null || derecha === void 0 ? void 0 : derecha.Tipo.tipos) {
                            case tipo_1.tipos.BOOLEANO:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un String con un booleano", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.CADENA:
                            ...
                            case tipo_1.tipos.CARACTER:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un String con un caracter", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.ENTERO:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un String con un Entero", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.DOBLE:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un String con un Dooble", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                        }
                    case tipo_1.tipos.DOBLE:
                        switch (derecha === null || derecha === void 0 ? void 0 : derecha.Tipo.tipos) {
                            case tipo_1.tipos.BOOLEANO:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un Double con un booleano", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.CADENA:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un Double con un string", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.CARACTER:
                                if ((izquierda === null || izquierda === void 0 ? void 0 : izquierda.valor) < (derecha === null || derecha === void 0 ? void 0 : derecha.valor.charCodeAt())) {
                                    return new literal_1.default(this.linea, this.columna, true, tipo_1.tipos.BOOLEANO);
                    ...
                    case tipo_1.tipos.BOOLEANO:
                        switch (derecha === null || derecha === void 0 ? void 0 : derecha.Tipo.tipos) {
                            ...
                            case tipo_1.tipos.CADENA:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un Booleano con un string", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.CARACTER:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un Booleano con un char", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.ENTERO:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un Booleano con un int", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            case tipo_1.tipos.DOBLE:
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede comparar un Booleano con un Doble", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                        }
                    default:
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
            ...
            case "!":
                ...
                arbol.num_error++;
                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Se esperaba tipo booleano", this.linea, this.columna));
            case "&&":
