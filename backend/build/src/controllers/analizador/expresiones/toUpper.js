...
class DECREMENTO extends expresion_1.Expresion {
    ...
    getValor(arbol, tabla) {
        ...
        if (comprobar.Tipo.tipos !== tipo_1.tipos.ERROR) {
            ...
            arbol.num_error++;
            arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "toUpper solo se puede realizar en un string", this.linea, this.columna));
            return new literal_1.default(this.linea, this.columna, "ERROR", tipo_1.tipos.ERROR);
        }
        if (this.exp instanceof variable_1.default) {
            arbol.num_error++;
            arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "La variable indicada no existe", this.linea, this.columna));
            return new literal_1.default(this.linea, this.columna, "ERROR", tipo_1.tipos.ERROR);
        }
        return new literal_1.default(this.linea, this.columna, "ERROR", tipo_1.tipos.ERROR);
    }
