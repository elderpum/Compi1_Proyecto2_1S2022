            ...
            switch (this.nombre.toUpperCase()) {
                case "LENGTH":
                    if (!(valor.valor instanceof Array) && typeof (valor.valor) !== typeof ("")) {
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "El valor ingresado no es una lista o vector o string", this.linea, this.columna));
                ...
                case "TRUNCATE":
                    if (typeof (valor.valor) !== typeof (1)) {
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "El valor ingresado no es un int o un double", this.linea, this.columna));
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                    }
                ...
                case "TOSTRING":
                    if (valor.valor instanceof literal_1.default) {
                        if (valor.valor.valor instanceof Array) {
                            arbol.num_error++;
                            arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se puede convertir un vector o lista en string", this.linea, this.columna));
                            return new literal_1.default(this.linea, this.columna, "error", tipo_1.tipos.ERROR);
                        }
                    }
                ...
                case "TOCHARARRAY":
                    if (typeof (valor.valor) !== typeof ("")) {
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "El valor ingresado no es una string", this.linea, this.columna));
                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                    }
                    return new literal_1.default(this.linea, this.columna, Array.from(valor.valor), tipo_1.tipos.CARACTER);
                default:
                    arbol.num_error++;
                    arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "función inexistente", this.linea, this.columna));
                    return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
            }
        }
        arbol.num_error++;
        arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "El valor indicado no existe", this.linea, this.columna));
        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
    }
    getNodo() {
