...
class FUNCION extends expresion_1.Expresion {
    ...
    getValor(arbol, tabla) {
        ...
        if (comprobar.tipo.tipos !== tipo_1.tipos.ERROR || comprobar2.tipo.tipos !== tipo_1.tipos.ERROR) {
                    ...
                    if (typeof (res) === typeof ({}) && !(res instanceof expresion_1.Expresion)) {
                        if (res.nombre === "RETURN") {
                            if (arbol.pilaFuncion.length > 0) {
                                ...
                                if (retorno) {
                                    if (func.tipo.tipos === retorno.Tipo.tipos ||
                                        ...
                                        if (rest.Tipo.tipos === tipo_1.tipos.ERROR) {
                                            arbol.num_error++;
                                            arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTIO", "Error en valor de retorno", this.linea, this.columna));
                                        ...
                                        arbol.num_error++;
                                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTIO", "El tipo del retorno no coincide con el de la función", this.linea, this.columna));
                                        return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                                    }
                                }
                                ...
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "NO SE PUEDE RETORNAR FUERA DE UNA FUNCION", this.linea, this.columna));
                                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                            }
                        }
                        if (res.nombre === "BREAK") {
                            arbol.num_error++;
                            arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTIO", "No se puede utilizar break dentro de una función", this.linea, this.columna));
                            return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                        }
                        if (res.nombre === "CONTINUE") {
                            arbol.num_error++;
                            arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTIO", "No se puede utilizar continue dentro de una función", this.linea, this.columna));
                            return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                        }
                    }
                }
            ...
            if (!func.vector) {
                arbol.num_error++;
                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Se esperaba return", this.linea, this.columna));
                return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
            }
            arbol.pilaFuncion.pop();
            return;
            ...
            arbol.num_error++;
            arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "No se encontro la función", this.linea, this.columna));
            return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
        }
    }
    getNodo() {
