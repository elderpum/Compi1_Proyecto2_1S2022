...
class FOR extends Instruccion_1.Instruccion {
    ...
    ejecutar(arbol, tabla) {
        ...
        if (dec) {
            ...
            arbol.num_error++;
            arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "Se esperaba un booleano en la condición del for", this.linea, this.columna));
            return;
        }
        arbol.num_error++;
        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "error al declarar o asignar variable en el for", this.linea, this.columna));
        return;
        //ERROR
    }
    getNodo() {
