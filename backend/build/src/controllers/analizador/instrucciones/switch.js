...
class SWITCH extends Instruccion_1.Instruccion {
    ...
    ejecutar(arbol, tabla) {
                    ...
                    if (typeof (caso) !== typeof ("")) {
                        ...
                        if (val.Tipo.tipos !== tipo_1.tipos.ERROR) {
                            if (variable.Tipo.tipos === val.Tipo.tipos ||
                                            ...
                                            if (typeof (res) === typeof ([])) {
                                                if (res.nombre === "RETURN") {
                                                    ...
                                                    if (arbol.pilaCiclo.length > 0) {
                                                        ...
                                                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "NO SE PUEDE UTILIZAR BREAK FUERA DE UN CICLO", this.linea, this.columna));
                                                    }
                                                }
                                                    ...
                                                    if (arbol.pilaCiclo.length > 1) {
                                                        ...
                                                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "NO SE PUEDE UTILIZAR CONTINUE FUERA DE UN CICLO", this.linea, this.columna));
                                                    }
                                                }
                                                return;
                                            }
                                ...
                                arbol.num_error++;
                                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Constante de Case incorrecta", this.linea, this.columna));
                                break;
                            }
                        }
                        else {
        ...
        arbol.num_error++;
        arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "error al leer la variable condicional", this.linea, this.columna));
        return;
    }
    getNodo() {
