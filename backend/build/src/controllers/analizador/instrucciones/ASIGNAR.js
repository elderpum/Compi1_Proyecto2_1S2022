    ...
    ejecutar(arbol, tabla) {
        ...
        if (expre.tipo.tipos !== tipo_1.tipos.ERROR) {
            ...
            if (this.tip === "VECTOR" && expre.DIMENSION === -1) {
                arbol.num_error++;
                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Llamada de vector erronea", this.linea, this.columna));
                return false;
            }
            else if (this.tip === "LIST" && expre.CANTIDAD === -1) {
                arbol.num_error++;
                arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Llamada de lista erronea", this.linea, this.columna));
                return false;
            }
            if (expre.tipo.tipos !== (value === null || value === void 0 ? void 0 : value.Tipo.tipos) && expre.tipo.tipos !== tipo_1.tipos.ENTERO
                ...
                arbol.errores.push(new Errores_1.default(arbol.num_error, "Semantico", "el tipado de la variable no coincide con el del valor indicado", this.linea, this.columna));
                return false;
            }
            this.ast = true;
            const comprobar = tabla.update(this.ID, value, ubic);
            if (!comprobar) {
                arbol.errores.push(new Errores_1.default(arbol.num_error, "Semantico", "No se encontro la variable " + this.ID, this.linea, this.columna));
                return false;
            }
            this.ubic = ubic;
            return true;
        ...
        arbol.num_error++;
        arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Variable no declarada", this.linea, this.columna));
        return false;
        //ERROR
    }
    getNodo() {
