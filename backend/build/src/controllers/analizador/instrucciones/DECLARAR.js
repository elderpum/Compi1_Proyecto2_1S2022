    ...
    ejecutar(arbol, tabla) {
        ...
        if (this.tipo2 instanceof tipo_1.default) {
            if (this.tipo2.tipos !== this.tipo.tipos) {
                arbol.num_error++;
                arbol.errores.push(new Errores_1.default(arbol.num_error, "Semantico", "El tipo de declaración no coincide con el de la variable", this.linea, this.columna));
                return false;
            }
        }
            ...
            for (let valores of this.exp) {
                ...
                if (value) {
                    if (value.Tipo.tipos !== this.tipo.tipos) {
                        arbol.num_error++;
                        arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "tipo dentro de valores de la declaración no coincide", value.linea, value.columna));
                    ...
                    arbol.num_error++;
                    arbol.errores.push(new Errores_1.default(arbol.num_error, "SINTACTICO", "fallo al obtener el valor", valores.linea, valores.columna));
                    return new literal_1.default(this.linea, this.columna, undefined, tipo_1.tipos.ERROR);
                }
            }
            this.lista = nueva;
        ...
        if (comprobar.tipo.tipos === tipo_1.tipos.ERROR) {
            ...
            if (ex) {
                if (ex.Tipo.tipos === tipo_1.tipos.ERROR) {
                    arbol.num_error++;
                    arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Fallo al asignar", this.linea, this.columna));
                    return false;
                }
                if (ex.Tipo.tipos !== this.tipo.tipos && this.tipo.tipos !== tipo_1.tipos.DOBLE
                    && this.tipo.tipos !== tipo_1.tipos.ENTERO) {
                    arbol.num_error++;
                    arbol.errores.push(new Errores_1.default(arbol.num_error, "Semantico", "los tipos ingresados no coinciden", this.linea, this.columna));
                    return false;
                }
            ...
            if (this.DIMENSION != -1 && v1 < 0) {
                arbol.num_error++;
                arbol.errores.push(new Errores_1.default(arbol.num_error, "Semantico", "Tamaño de vector invalido", this.linea, this.columna));
                return false;
            }
        ...
        arbol.num_error++;
        arbol.errores.push(new Errores_1.default(arbol.num_error, "Semantico", "La Variable ya esta declarada", this.linea, this.columna));
        return false;
    }
    getNodo() {
