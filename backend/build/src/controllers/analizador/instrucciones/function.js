...
class FUNCIONF extends Instruccion_1.Instruccion {
    ...
    ejecutar(arbol, tabla) {
        ...
        if (up === "LENGTH" || up === "TRUNCATE" || up === "ROUND"
            ...
            arbol.num_error++;
            arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Existe una función nativa con este nombre", this.linea, this.columna));
            return;
        }
        ...
        arbol.num_error++;
        arbol.errores.push(new Errores_1.default(arbol.num_error, "SEMANTICO", "Ya existe una función con el nombre indicado", this.linea, this.columna));
        return;
        // ERROR
    }
    getNodo() {
